		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="javascript:void(0)">${itemCat1Name}</a>
					</li>
					<li>
						<a href="javascript:void(0)">${itemCat2Name}</a>
					</li>
					<li>
						<a href="javascript:void(0)">${itemCat3Name}</a>
					</li>
				</ul>
			</div>
			<!--product-info-->
						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<#list specificationList as specification>
								<dl>
									...
									<#list specification.attributeValue as val>
										<dd><a href="javascript:void(0);" class="{{isSelected('${specification.attributeName}','${val}')?'selected':''}}" ng-click="updateSpec('${specification.attributeName}','${val}')">${val}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:void(0)" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
